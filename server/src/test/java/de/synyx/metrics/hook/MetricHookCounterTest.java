...
public class MetricHookCounterTest extends MetricHookTest {
    ...
    public void testName () throws NoSuchMethodException {
        assertThat (de.synyx.metrics.annotation.Counter.class.getMethod ("value").getDefaultValue (), equalTo ((Object) "#"));
    }

    @Test
    public void testBoth () {
        for (de.synyx.metrics.annotation.Counter.Operation operation : de.synyx.metrics.annotation.Counter.Operation.values ()) {
            de.synyx.metrics.annotation.Counter annotation = annotation (Kind.Both, operation, number);

            MetricHook counter;

            counter = new MetricHookCounter (locator, metric, annotation);
            counter.before ();
    ...
    public void testError () {
        for (de.synyx.metrics.annotation.Counter.Operation operation : de.synyx.metrics.annotation.Counter.Operation.values ()) {
            de.synyx.metrics.annotation.Counter annotation = annotation (Kind.Error, operation, number);
    ...
    public void testSuccess () {
        for (de.synyx.metrics.annotation.Counter.Operation operation : de.synyx.metrics.annotation.Counter.Operation.values ()) {
            de.synyx.metrics.annotation.Counter annotation = annotation (Kind.Success, operation, number);
    ...
    public void testMetriculate () {
        ...
        for (de.synyx.metrics.annotation.Counter.Operation operation : de.synyx.metrics.annotation.Counter.Operation.values ()) {
            de.synyx.metrics.annotation.Counter annotation;
        ...
        verify (locator, times (2 * 3)).inject (test);
        verify (locator, times (2 * 3)).postConstruct (test);
        verify (locator, times (2 * 3)).preDestroy (test);
    }

    private de.synyx.metrics.annotation.Counter annotation (Kind kind, de.synyx.metrics.annotation.Counter.Operation operation, long number) {
        de.synyx.metrics.annotation.Counter annotation;

              annotation = mock (de.synyx.metrics.annotation.Counter.class);
