...
public class MetricReportHandlerGangliaTest extends MetricReportTestSupport {
    ...
    public void testScheme () throws Exception {
        assertThat (new MetricReportHandlerGanglia ().scheme (), equalTo ("ganglia"));
    }
    ...
    public void testReporter () throws Exception {
        Optional<ScheduledReporter> reporter;
                       ...
                       reporter = new MetricReportHandlerGanglia ().select (mediator (), registry, URI.create ("ganglia://localhost:23443"));
        assertThat     (reporter.get (), instanceOf (GangliaReporter.class));
    ...
    public void testReporterExplicitV30 () throws NoSuchFieldException, IllegalAccessException {
        Optional<ScheduledReporter> reporter;
                    ...
                    reporter = new MetricReportHandlerGanglia ().select (mediator (), registry, URI.create ("ganglia://localhost:23443?version=3.0"));
        assertThat (reporter.get (), instanceOf (GangliaReporter.class));
    ...
    public void testReporterExplicitV31 () throws NoSuchFieldException, IllegalAccessException {
        Optional<ScheduledReporter> reporter;
                    ...
                    reporter = new MetricReportHandlerGanglia ().select (mediator (), registry, URI.create ("ganglia://localhost:23443?version=3.1"));
        assertThat (reporter.get (), instanceOf (GangliaReporter.class));
    ...
    public void testReporterExplicitUnknown () throws NoSuchFieldException, IllegalAccessException {
        Optional<ScheduledReporter> reporter;
                    ...
                    reporter = new MetricReportHandlerGanglia ().select (mediator (), registry, URI.create ("ganglia://localhost:23443?version=w00t"));
        assertThat (reporter.get (), instanceOf (GangliaReporter.class));
    }
    ...
    public void testReporterQuery () throws NoSuchFieldException, IllegalAccessException {
        ...
        Optional<ScheduledReporter> reporter;
                        ...
                        reporter = new MetricReportHandlerGanglia ().select (mediator (), registry, URI.create ("ganglia://localhost:23443?rate=m&duration=h&tmax=232&dmax=768&prefix=" + prefix));
        assertThat     (reporter.get (), instanceOf (GangliaReporter.class));
    ...
    private void assertOption (GangliaReporter ganglia, String prefix, int dmax, int tmax) throws NoSuchFieldException, IllegalAccessException {
        assertThat (field (GangliaReporter.class, "prefix", String.class, ganglia), equalTo (prefix));
        assertThat (field (GangliaReporter.class, "dMax", Integer.class, ganglia),  equalTo (dmax));
        assertThat (field (GangliaReporter.class, "tMax", Integer.class, ganglia),  equalTo (tmax));
    }
    ...
    private void assertProtocol (GangliaReporter ganglia, Class<? extends Protocol> protocol) throws NoSuchFieldException, IllegalAccessException {
        ...
        assertThat (field (GMetric.class, "protocol", Protocol.class, g), instanceOf (protocol));
    }
