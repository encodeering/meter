...
public final class MeterProviders {
    ...
    public final static Function<String, Meter<Dimensionless>> counterOf (final MeterProvider provider) {
        return new Function<String, de.synyx.metrics.core.Meter<Dimensionless>> () {

            @Override
            public final de.synyx.metrics.core.Meter<Dimensionless> apply (String name) {
    ...
    public final static Function<String, Meter<Duration>> timerOf (final MeterProvider provider) {
        return new Function<String, de.synyx.metrics.core.Meter<Duration>> () {

            @Override
            public final de.synyx.metrics.core.Meter<Duration> apply (String name) {
