...
public class MetricAspectHistogramTest extends MetricAspectTest {
    ...
    public void testBothNN () {
        ...
        aspect = new MetricAspectHistogram (annotation, supplier, Optional.<Metriculate>absent ());
        aspect.before ();
    ...
    public void testMetriculateNN () {
...

        {
            ...
            aspect = new MetricAspectHistogram (annotation, supplier, Optional.<Metriculate>of (test));
            aspect.before ();
            aspect.after  (null, null);
    ...
    public void testMetriculateNT () {
...

        {
            ...
            histogram = new MetricAspectHistogram (annotation, supplier, Optional.<Metriculate>of (test));
            histogram.before ();
