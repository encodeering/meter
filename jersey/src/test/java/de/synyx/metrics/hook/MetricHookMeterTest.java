...
public class MetricHookMeterTest extends MetricHookTest {
    ...
    public void testName () throws NoSuchMethodException {
        assertThat (de.synyx.metrics.annotation.Meter.class.getMethod ("value").getDefaultValue (), equalTo ((Object) "#"));
    }

    @Test
    public void testBoth () {
        de.synyx.metrics.annotation.Meter annotation = annotation (Kind.Both, number);

        MetricHook meter;

        meter = new MetricHookMeter (locator, metric, annotation);
        meter.before ();
    ...
    public void testError () {
        de.synyx.metrics.annotation.Meter annotation = annotation (Kind.Error, number);
    ...
    public void testSuccess () {
        de.synyx.metrics.annotation.Meter annotation = annotation (Kind.Success, number);
    ...
    public void testMetriculate () {
        ...
        {
            de.synyx.metrics.annotation.Meter annotation;
    ...
    private de.synyx.metrics.annotation.Meter annotation (Kind kind, long number) {
        de.synyx.metrics.annotation.Meter annotation;

              annotation = mock (de.synyx.metrics.annotation.Meter.class);
